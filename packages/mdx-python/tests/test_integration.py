...
class TestRendererIntegration:
    ...
    def test_render_math_nodes_katex(self):
        ...
        """
        nodes = omni_mdx.parse("Inline: $a^2+b^2=c^2$\n\nBlock:\n$$E=mc^2$$")
    ...
    def test_render_custom_jsx_component(self):
        ...
        nodes = omni_mdx.parse('<Alert level="danger">System halt</Alert>')
    ...
    def test_component_fallback(self):
        ...
        nodes = omni_mdx.parse('<Unknown prop="test">Content</Unknown>')
